		...
		if(e.getSource() instanceof JMenuItem){
			...
			case BNT_DELL:
				if(vc.deleteRest() == null) {
					JOptionPane.showMessageDialog(vc, "Debe seleccionar el registro a eliminar","Error",JOptionPane.ERROR_MESSAGE);
				}else {
					...
					if (respuesta == JOptionPane.YES_OPTION) {
						JOptionPane.showMessageDialog(vc, tr.deleteRest(vc.deleteRest()),"Error",JOptionPane.INFORMATION_MESSAGE);
						vc.chargeTable(tr.getConsulta(vc.getConsulta()[0], vc.getConsulta()[1]));
					}
				}
				break;
			...
			//TODO: hacer los if de guardar datos pero con getSource y gets en los paneles
		}
	}
